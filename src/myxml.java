		...
		try {
			...
			for (int s = 0; s < nodeLst.getLength(); s++) {
				...
				if (fstNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					System.out.println("PrerequisitName: "
							+ ((Node) foNm.item(0)).getNodeValue());
					...
					System.out.println("PrerequisitNumber: "
							+ ((Node) fivNm.item(0)).getNodeValue());
					...
					System.out.println("CourseAttributes: "
							+ ((Node) sevNm.item(0)).getNodeValue());
